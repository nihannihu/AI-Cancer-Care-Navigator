...
class EmailService:
    ...
    def _create_plain_text_body(self, patient_data: Dict[str, Any], appointment_details: Dict[str, Any]) -> str:
        ...
        """
        doctor_name = appointment_details.get('doctor_name', 'Dr. Sharma')
        appointment_time = appointment_details.get('preferred_time', 'Not specified')
...
Patient Details:
----------------
Patient Name: {patient_data.get('username', 'N/A')}
Patient Email: {patient_data.get('email', 'N/A')}

Appointment Details:
--------------------
Doctor: {doctor_name}
Preferred Time: {appointment_time}
Booking Date: {self._get_current_timestamp()}

Next Steps:
-----------
1. Please review the appointment details
2. Confirm the appointment with the patient if needed
3. Prepare for the consultation

This is an automated message from Onco-Navigator AI System
        """.strip()
